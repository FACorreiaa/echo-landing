        ...
        <section className="py-24 px-4 sm:px-6 lg:px-8 border-t border-white/5">
            <div className="max-w-6xl mx-auto">
                <FadeIn delay={0.2} className="text-center mb-16">
                    <span className="inline-block px-4 py-1.5 text-sm font-medium text-[oklch(0.65_0.18_220)] bg-[oklch(0.65_0.18_220_/_0.15)] rounded-full mb-4 ring-1 ring-[oklch(0.65_0.18_220_/_0.2)]">
                        Core Features
                    </span>
                    ...
                    <p className="text-zinc-400 max-w-2xl mx-auto text-lg">
                        Lightweight features that make Echo feel <span className="text-white font-medium">alive</span> — without overwhelming you.
                    </p>
                </FadeIn>

                <FadeInStagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-24">
                    {coreFeatures.map((feature, index) => (
                        <motion.div key={index} variants={fadeInItem}>
                            <Spotlight
                                className="h-full rounded-xl bg-white/[0.02] border border-white/5 hover:border-white/10 transition-colors"
                ...
                {/* Advanced Features */}
                <FadeIn delay={0.2} className="text-center mb-16">
                    <span className="inline-block px-4 py-1.5 text-sm font-medium text-[oklch(0.55_0.2_170)] bg-[oklch(0.55_0.2_170_/_0.15)] rounded-full mb-4 ring-1 ring-[oklch(0.55_0.2_170_/_0.2)]">
                        Advanced Features
                    </span>
                    <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4 tracking-tight">
                    ...
                    <p className="text-zinc-400 max-w-2xl mx-auto text-lg">
                        Deep integrations and advanced analytics for those who want <span className="text-white font-medium">complete control</span>.
                    </p>
                </FadeIn>
                ...
                <FadeInStagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {advancedFeatures.map((feature, index) => (
                        <motion.div key={index} variants={fadeInItem}>
                            <Spotlight
                                className={`h-full rounded-xl border transition-all duration-300 ${feature.highlight
                                    ? "bg-gradient-to-br from-[oklch(0.65_0.18_220_/_0.08)] to-[oklch(0.55_0.2_170_/_0.08)] border-[oklch(0.65_0.18_220_/_0.2)]"
                                    : "bg-white/[0.02] border-white/5"
                                    }`}
                                fill={feature.highlight ? "rgba(6, 182, 212, 0.1)" : "rgba(255, 255, 255, 0.05)"}
                            >
                                <div className="p-5 h-full flex flex-col">
                                    <feature.icon
