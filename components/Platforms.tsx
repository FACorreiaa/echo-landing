                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-4 mb-4">
                            ...
                            <a
                                href="#waitlist"
                                className="flex items-center gap-3 px-5 py-3 bg-black border border-white/20 rounded-xl hover:bg-white/5 transition-all duration-300 group"
                            >
                    ...
                    <div className="relative h-[500px] hidden lg:block">
                        {/* Glow effect */}
                        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full bg-[oklch(0.5_0.2_220_/_0.2)] blur-[100px]" />

                        {/* Laptop mockup */}
                        <div className="absolute right-0 top-8 w-[380px]">
                            <div className="relative">
                                {/* Screen */}
                                <div className="bg-[oklch(0.12_0.02_250)] rounded-t-xl border border-white/10 p-2">
                                    <div className="bg-[oklch(0.08_0.02_250)] rounded-lg aspect-[16/10] flex items-center justify-center overflow-hidden">
                                        <div className="w-full h-full bg-gradient-to-br from-[oklch(0.15_0.03_220)] to-[oklch(0.12_0.02_250)] p-4">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <div className="h-8 w-full bg-gradient-to-r from-[oklch(0.65_0.18_220_/_0.3)] to-transparent rounded" />
                        ...
                        {/* Tablet mockup */}
                        <div className="absolute left-8 bottom-0 w-[200px]">
                            <div className="bg-[oklch(0.12_0.02_250)] rounded-2xl border border-white/10 p-2 rotate-[-5deg] shadow-2xl">
                                <div className="bg-[oklch(0.08_0.02_250)] rounded-xl aspect-[3/4] flex items-center justify-center overflow-hidden">
                                    <div className="w-full h-full bg-gradient-to-br from-[oklch(0.15_0.03_220)] to-[oklch(0.12_0.02_250)] p-3">
                                        <div className="space-y-2">
                                            ...
                                            <div className="h-6 w-full bg-gradient-to-r from-[oklch(0.55_0.2_170_/_0.3)] to-transparent rounded" />
                        ...
                        {/* Phone mockup */}
                        <div className="absolute left-1/3 top-12 w-[100px]">
                            <div className="bg-[oklch(0.12_0.02_250)] rounded-2xl border border-white/10 p-1.5 rotate-[8deg] shadow-2xl">
                                {/* Notch */}
                                ...
                                <div className="bg-[oklch(0.08_0.02_250)] rounded-xl aspect-[9/19] overflow-hidden">
                                    <div className="w-full h-full bg-gradient-to-br from-[oklch(0.15_0.03_220)] to-[oklch(0.12_0.02_250)] p-2 pt-4">
                                        <div className="space-y-1.5">
                                            ...
                                            <div className="h-4 w-full bg-gradient-to-r from-[oklch(0.65_0.18_220_/_0.3)] to-transparent rounded" />
